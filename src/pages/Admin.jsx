...
export default function Admin() {
    ...
    const { birds, loading: birdsLoading } = useBirds();
    ...
    return (
        <div className="pt-32 pb-20 min-h-screen bg-primary-50/30">
            <div className="container mx-auto px-6">
                ...
                {/* Dashboard Tabs */}
                <div className="bg-white rounded-[40px] shadow-sm border border-primary-50 overflow-hidden">
                    ...
                    <div className="p-8 md:p-12">
                        <div className="flex justify-between items-center mb-10">
                            ...
                            <button className="flex items-center gap-2 px-6 py-3 bg-primary-500 text-white rounded-full font-sans text-[10px] tracking-widest uppercase font-bold hover:bg-primary-600 transition-all shadow-lg shadow-primary-100">
                                <PlusCircle size={14} />
                                        ...
                                        birds.map((bird) => (
                                            <tr key={bird.id} className="group hover:bg-primary-50/30 transition-colors">
                                                ...
                                                <td className="py-6 text-right space-x-2">
                                                    <button className="p-2 text-muted hover:text-primary-600 transition-colors"><Edit3 size={16} /></button>
                                                    <button className="p-2 text-muted hover:text-red-500 transition-colors"><Trash2 size={16} /></button>
                                                </td>
                                            </tr>
                                        ))
                                    ) : (
